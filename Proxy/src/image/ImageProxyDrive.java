...
public class ImageProxyDrive {
    ImageComponent imageComponent;
    JFrame frame = new JFrame("Album Cover Viewr");
    JMenuBar menuBar;
    JMenu menu;
    Hashtable<String, String> albums = new Hashtable<>();

    public static void main(String[] args) throws Exception {
        ImageProxyDrive testDrive = new ImageProxyDrive();
    }

    public ImageProxyDrive() throws Exception{
